...
be an idealization of the actual LCR circuit for which we was really testing. Though the resistance was small, there was
...
In fact, the inductor does actually have some small capacitance as well, from acumulated charge between each wiring. Thus a small capasitor 
