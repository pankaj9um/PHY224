...
the vacuum tube, filled by a low density gas for minimal electron resistance, though which gives some rare collisions which emit
...
The constant factor is due to measurements done with constant voltage. The intercept of the fitted line gives $B_e = 0.000013 \pm 0.000001$ Tesla.
...
obtained in our case is $-(1.61 \pm 0.29) \times 10^{11}\ C/kg$.
...
For the calculation of $B_e$, the uncertainty is given by the fitting function. Hence $\Delta B_e = \Delta (y-intercept) = \pm 0.000001$ Tesla.

For the computation of the charge to mass ratio, we have $\frac{e}{m} = (\frac{slope}{k(I-I_0)})^2 \implies 
\Delta (\frac{e}{m}) = 2 (slope) \frac{\Delta (slope)}{(k(I-I_0))^2}$. The uncertainty is then $\Delta (\frac{e}{m}) = \pm 0.29 \times 10^{11}\ C/kg$.
